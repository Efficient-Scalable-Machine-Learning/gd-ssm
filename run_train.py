import argparse
from gd_ssm.utils.util import str2bool
from gd_ssm.linear_regression import train
...
if __name__ == "__main__":
	...
	## incontext data
	parser.add_argument("--regression",type=str,choices=['linear','non-linear'],default='linear',help='regression type')
	...
	parser.add_argument("--size_distract", type=int,
						default=0,
						help="size distract")
	parser.add_argument("--input_range", type=float,
						default=1.0,
						help="input range")
	...
	parser.add_argument("--ood_analyse", type=str2bool, default=False,
						help="Analysis on OOD data")
	parser.add_argument("--num_feature_analyse", type=str2bool, default=False,
						help="Analysis on feature size")
 

	# Model Parameters
	parser.add_argument("--n_layers", type=int, default=1,
						help="Number of layers in the network")
	parser.add_argument("--attn_window", type=int, default=3,
						help="local self attention window. Fixed as 3 for regression tasks")
	parser.add_argument("--stride", type=int, default=2,
						help="stride for applying local self attention. Fixed as 2 for regression tasks")
	...
	if args.regression=='linear':
		...
		from gd_ssm.non_linear_regression import train
	train(args)
